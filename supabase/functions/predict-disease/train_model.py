...
def train_and_export(dataset_file='dataset.csv', use_real_data=True):
    print("=" * 60)
    ...
    # Save to JSON
    output_file = 'trained_disease_model.json'
    print(f"\nSaving model to {output_file}...")
    with open(output_file, 'w') as f:
        json.dump(model_export, f, indent=2)
    
    print(f"\n[OK] Model exported to {output_file}")
...
if __name__ == "__main__":
    ...
    train_and_export(dataset_file=dataset_file, use_real_data=use_real_data)
